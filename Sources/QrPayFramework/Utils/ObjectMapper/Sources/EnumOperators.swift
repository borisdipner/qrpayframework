...
/// Object of Raw Representable type
 func <- <T: RawRepresentable>(left: inout T, right: Map) {
	left <- (right, EnumTransform())
}

 func >>> <T: RawRepresentable>(left: T, right: Map) {
	left >>> (right, EnumTransform())
}
...
/// Dictionary of Raw Representable object
 func <- <T: RawRepresentable>(left: inout [String: T], right: Map) {
	left <- (right, EnumTransform())
}

 func >>> <T: RawRepresentable>(left: [String: T], right: Map) {
	left >>> (right, EnumTransform())
}
